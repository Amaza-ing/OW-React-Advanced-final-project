...
function App() {
  return (
    <>
      <div>
        <h1>Bienvenidos al proyecto final de React Avanzado</h1>
        <hr />
        <h3>
          Este proyecto está separado por ramas, tienes cada lección y ejemplo en
          cada rama.
        </h3>
        <h4>
          Puedes ver cada rama en el{" "}
          <a
            href="https://github.com/Amaza-ing/OW-React-Advanced-final-project"
            target="_blank"
          >
